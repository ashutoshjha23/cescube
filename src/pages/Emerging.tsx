...
const StrategicForesight = () => {
  return (
    <div className="relative font-sans bg-gray-900 text-gray-100 min-h-screen overflow-hidden">
      {/* Animated Background */}
      <motion.div
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-7xl">
          ...
          >
            <p className="leading-relaxed text-base md:text-lg text-gray-200">
              In a world defined by uncertainty, strategic foresight is the
              ultimate shield. Whether it’s a sudden border flare-up, a cyber
              blackout, or a global pandemic, the element of surprise can
              devastate national readiness. Traditional intelligence often tells
              us what is—foresight tells us what could be.
            </p>
            <p className="leading-relaxed text-base md:text-lg text-gray-200 mt-4">
              India must pre-empt—not just react. This department was created to
              equip national security thinkers with the ability to game out
              future scenarios, test assumptions through simulations, and
              visualise both opportunities and risks across all domains—land,
              sea, air, cyber, space, and cognitive.
            </p>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-3 text-gray-200 text-base md:text-lg list-disc list-inside">
              <li>
                <strong>Anticipating the next war, not the last:</strong>{" "}
                Scenario thinking breaks the trap of historical assumptions.
              </li>
              <li>
                <strong>Avoiding strategic surprise:</strong> Red-teaming and
                wild card analysis can highlight blind spots before adversaries
                exploit them.
              </li>
              <li>
                <strong>Planning across time horizons:</strong> From near-term
                readiness to long-term existential shifts (AI dominance, water
                wars).
              </li>
            </ul>
          </motion.div>
