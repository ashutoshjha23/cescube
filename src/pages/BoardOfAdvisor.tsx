...
const AdvisorCard = ({ advisor }) => {
  return (
    ...
    >
      ...
      <h3 className="text-xl font-bold text-news-dark dark:text-white">{advisor.name}</h3>
      <p className="text-news-primary text-sm mb-2">{advisor.role}</p>
      <p className="text-gray-700 dark:text-gray-300 text-sm text-justify">{advisor.bio}</p>
    </motion.div>
  );
};
