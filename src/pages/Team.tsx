...
import SarabjeetImg from "@/assets/advisors/Sarabjeetimg.jpg";
// Research Domain - Academic research, policy analysis, and scholarly work
const researchTeam = [
  {
    name: "Captain Sarabjeet Singh Parmar (Retd)",
    role: "Head - Department of Maritime Warfare and Director - Expansion and Partnership",
    bio: `An alumnus of National Defence Academy (NDA) Kharakwasla, and Defence Services Staff College (DSSC) Wellington, Captain Parmar was commissioned into the Indian Navy on 01 July 1987 and retired on 30 June 2023. He is a Sea King pilot who has commanded two ships and a frontline Anti-Submarine and Anti-Shipping helicopter squadron. He was member of the XI Indian Antarctic Summer Expedition in 1991 and has attended the South Asia Regional Governance and Management Defence Course Conducted by the British Government at Colombo in 2005. He represented the Indian Navy in the first international HOSTAC (helicopter operations from ships other than aircraft carriers) conference held at Norfolk, USA in 2008. He has served as Joint Director Naval Plans in Directorate of Naval Planning at IHQ MoD (Navy). He has been Directing Staff at Defence Services Staff College (DSSC), Wellington, where he was responsible for the national strategy and international law modules. As a Research Fellow at the then Institute for Defence Studies and Analyses (IDSA), New Delhi from 2010 to 2014, he looked at HADR, maritime strategy and security related issues in the South China Sea and the Indian Ocean Region. Post IDSA he worked in the Indian Navy’s strategic apex level offices from 2014 to 2018. As Director (Strategy) in the Directorate of Strategy Concepts and Transformation at IHQ MoD (Navy) he was part of the core team that revised Indian Navy’s unclassified maritime security strategy document and doctrine, released as Ensuring Secure Seas: Indian Maritime Security Strategy in 2015. At the Maritime Doctrines and Concepts Centre, as Director Strategic Maritime Assessment and Doctrine Development, he carried out regional maritime assessments and completed the doctrine development plan. He was Executive Director and Senior Fellow at the National Maritime Foundation from 2018 till retirement. He has written and spoken extensively on maritime security and strategy issues at various national and international conferences and is invited to participate in various bi/ minilateral track 2 meetings. His main areas of research include national and maritime strategy and security related aspects in the Indo-Pacific, piracy, HADR, and international maritime law with a focus on UNCLOS and lawfare. He is presently a Distinguished Fellow at Council of Strategic and Defence Research, New Delhi; Australia India Institute, Melbourne; Indo-Pacific Studies Centre, Melbourne; and Centre of Military History and Conflict Studies at the United Service Institution of India, New Delhi. His writings can be accessed at https://www.researchgate.net/profile/Captain-Sarabjeet-Parmar and https://independent.academia.edu/sarabjeetparmar.`,
    image: SarabjeetImg,
  },
    {
